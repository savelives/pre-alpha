...
<html lang="en">
<head>
    <title>Code coverage report for express-enrouten/lib/directory.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">express-enrouten/lib/directory.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">express-enrouten/lib/</a> &#187; directory.js</div>
</div>
<div class="body">
...
&nbsp;
    if (stat.isDirectory()) {
        ancestors = ancestors ? <span class="branch-0 cbranch-no" title="branch not covered" >path.join(ancestors, current) </span>: current;
...
&nbsp;
    try {
        ...
        file = ext ? file.slice(0, -ext.length) : <span class="branch-1 cbranch-no" title="branch not covered" >file;</span>
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Thu Mar 27 2014 12:57:17 GMT-0700 (PDT)</div>
</div>
